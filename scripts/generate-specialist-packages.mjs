...
const SPECIALISTS = [
  ...
  {
    pkg: "specialist-document-editor",
    id: "document-editor",
  ...
  {
    pkg: "specialist-document-writer",
    id: "document-writer",
  ...
  {
    pkg: "specialist-design-branding",
    id: "design-branding",
...
export function registerApiRoutes(app: Elysia) {
  app.get("/", () => ({ specialist: ${JSON.stringify(spec.id)}, ok: true }));
