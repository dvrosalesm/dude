# Presentation editor (document-editor) specialist skill packs
...
The specialist id is `document-editor` for historical reasons (it edits PowerPoint-style presentations); the user-facing name is "Presentation Editor".
