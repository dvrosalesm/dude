# Website (prospect) specialist skill packs
...
The specialist id is `prospect` for historical reasons; the user-facing role is the "Website Specialist" (landing pages, lead capture funnels, conversion).
