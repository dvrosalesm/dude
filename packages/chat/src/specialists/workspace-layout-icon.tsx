...
export function getSpecialistColor(specialistId?: string) {
  return (specialistId && SPECIALIST_COLORS[specialistId]) || "var(--dude-muted)";
}
...
export function WorkspaceLayoutIcon({ specialistId, className, style }: Props) {
