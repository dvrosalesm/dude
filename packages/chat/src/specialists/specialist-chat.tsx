...
/**
 * Shared specialist chat UI — thin composer over focused submodules.
 */
...
import { InputBar } from "./specialist-chat/input-bar";
import { MessagesList } from "./specialist-chat/messages-list";
import { LastMessagePreview } from "./specialist-chat/message-previews";
import type { SpecialistChatProps } from "./specialist-chat-props";

export type { SpecialistChatProps } from "./specialist-chat-props";

export function SpecialistChat(props: SpecialistChatProps) {
  const {
    messages,
    newMessage,
    onMessageChange,
