...
export function InputBar({
  ...
  const handleDragOver = (event: React.DragEvent) => {
    ...
    const hasNode = event.dataTransfer.types.includes("application/x-specialist-node");
  ...
  const handleDrop = (event: React.DragEvent) => {
    ...
    const nodeData = event.dataTransfer.getData("application/x-specialist-node");
