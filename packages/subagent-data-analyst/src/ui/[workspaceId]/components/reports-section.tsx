...
function RenderSpecCard({
  ...
  const runQuery = useCallback(
    createWorkspaceSqlQuery(subagentId, workspaceId),
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-h-0 p-4 overflow-hidden">
                  {report.renderSpec ? (
                    <RenderSpecCard renderSpec={report.renderSpec} chartColors={chartColors} subagentId={subagentId} workspaceId={workspaceId} />
                  ) : (
